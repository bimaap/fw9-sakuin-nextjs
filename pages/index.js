  ...
  return(
    <>
      <header className="d-flex align-items-center justify-content-center px-4 nv-bc-primary nv-h-25">
        <div className="nv-control-header-landing-page">
          ...
          <div className="d-flex align-items-center gap-3">
            <button className="nv-c-secondary nv-btn">Login</button>
      ...
      <section className="nv-bc-primary nv-h-100 d-flex align-items-center gap-4 justify-content-center">
        <img className="nv-image-phone" src='/images/phone.png' alt="Phone" />
        <div className="nv-control-width-fit nv-w-75 d-flex justify-content-center flex-column gap-4">
          <span className="nv-f-h2 nv-weight-700 nv-c-grey">All The <span className="nv-c-secondary">Great</span><br/>FazzPay Features.</span>
          <div className="nv-card nv-bc-white d-flex flex-column justify-content-center p-4 nv-c-primary">
            <div>
      ...
      <footer className="nv-bc-primary d-flex justify-content-center align-items-center px-4">
